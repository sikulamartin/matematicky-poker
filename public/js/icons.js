...
(function () {
  ...
  var PATHS = {
    ...
    eye: '<path d="M2.7 12S6.5 5.7 12 5.7 21.3 12 21.3 12 17.5 18.3 12 18.3 2.7 12 2.7 12z"/>' +
      '<circle cx="12" cy="12" r="3.1"/>',
    eyeOff: '<path d="M9.9 6a9 9 0 0 1 2.1-.3c5.5 0 9.3 6.3 9.3 6.3a17 17 0 0 1-2.8 3.5"/>' +
      '<path d="M6.4 7.7A17.2 17.2 0 0 0 2.7 12s3.8 6.3 9.3 6.3a8.8 8.8 0 0 0 3.4-.7"/>' +
      '<path d="M10 10a2.8 2.8 0 0 0 4 4"/><path d="M3.7 3.7l16.6 16.6"/>',
