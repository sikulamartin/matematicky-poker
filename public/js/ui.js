...
(function () {
  ...
  /**
   * Zavře otevřený dialog zvenčí, jako by hráč zvolil „nic“.
   *
   * Potřebuje to skupinová hra: dialog s výsledky visí na obrazovce, dokud ho
   * hráč nezavře, ale zadavatel může mezitím rozdat další kolo. Nechat přes
   * rozjetou hru viset pořadí z minulého kola je horší než dialog zavřít za něj.
   */
  function close() {
    if (closeCurrent) {
      closeCurrent(undefined);
  ...
  window.MPUI = {
    open: open, pickValue: pickValue, toast: toast, isOpen: isOpen, close: close
  };
})();
